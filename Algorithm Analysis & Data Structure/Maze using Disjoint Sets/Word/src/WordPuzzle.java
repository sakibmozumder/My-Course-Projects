...
public class WordPuzzle {
    ...
    public WordPuzzle( String e, boolean i)
    {
        this.prefix  = e;
        this.isWord = i;
    }
	...
	/*private static void getPuzzleWords(char Puzzle[][], int row, int column,MyHashTable <WordPuzzle<String>>dictPref)
	{
		//VerticalLtoR(Puzzle, row, column,dictPref);
	...
	private static void VerticalLtoR(char Puzzle[][], int row, int column,MyHashTable <WordPuzzle<String>>dictPref)
	{
	...
	*/
	...
	public static void main(String[] args) throws Exception
	{
		...
		MyHashTable<WordPuzzle>dictPref = new MyHashTable<>( );
		MyHashTable<String> PuzzleWord = new MyHashTable<>( );
		ArrayList<String> PuzzleWordList = new ArrayList<>( );
		WordPuzzle w=new WordPuzzle (null, false);
	...
	while(column>20);
		...
		for(int k=0;k<row;k++)
		{
			for(int l=0; l<column;l++) 
			{
				...
				{
					WordPuzzle p= new WordPuzzle(null,true);
					p.prefix=PuzzleRows[k].substring(l,m+1);
					if(dictPref.contains(p))
						{
							if (p.isWord)
							{
		...
		//getPuzzleWords(Puzzle,row,column,dictPref,);
